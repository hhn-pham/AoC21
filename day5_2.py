...
with open("day5-input", "r") as vent_list:
    ...
    for line in vent_list.readlines():
        ...
        if x1 == x2 or y1 == y2:
            vent_map_global = draw_vents(x1, x2, y1, y2, vent_map_global, False)
        else:
            vent_map_global = draw_vents(x1, x2, y1, y2, vent_map_global, True)
